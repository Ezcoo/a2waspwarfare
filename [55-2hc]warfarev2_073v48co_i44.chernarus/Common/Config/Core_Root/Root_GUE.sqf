...
if (isServer) then {
	...
	missionNamespace setVariable [Format["WFBE_%1_AI_Loadout_1", _side], [
		[['AKS_74_kobra','RPG7V','Makarov','I44_Binocular_M3','NVGoggles','ItemRadio','ItemMap'],
	...
	missionNamespace setVariable [Format["WFBE_%1_AI_Loadout_2", _side], [
		[['AKS_74_pso','RPG7V','Makarov','I44_Binocular_M3','NVGoggles','ItemRadio','ItemMap'],
	...
	missionNamespace setVariable [Format["WFBE_%1_AI_Loadout_3", _side], [
		[['AK_74_GL','RPG7V','I44_Binocular_M3','NVGoggles','ItemRadio','ItemMap'],
		 ...
		 ['AK_74_GL','RPG7V']],
		[['AK_74_GL','RPG7V','Makarov','I44_Binocular_M3','NVGoggles','ItemRadio','ItemMap'],
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGear", _side], [
	['AKS_74_kobra','Makarov','I44_Binocular_M3','NVGoggles','ItemCompass','ItemMap','ItemRadio','ItemWatch'],
