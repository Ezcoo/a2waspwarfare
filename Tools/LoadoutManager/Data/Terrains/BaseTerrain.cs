...
public abstract class BaseTerrain : InterfaceTerrain
{
    ...
    public static void GenerateAndWriteVersionSqf(string _sqfFilePath)
    {
        // Define the SQF code specific to Chernarus terrain
        string versionSqfCode = @"#define WF_DEBUG 1
            #define WF_CAMO 
            #define COMBINEDOPS 1
            #define WF_MAXPLAYERS 55
            #define WF_MISSIONNAME ""[55] Warfare V48 Chernarus""
