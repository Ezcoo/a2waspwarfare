...
missionNamespace setVariable [Format["WFBE_%1PARAVEHICARGO", _side], 'UralRepair_INS'];//--- Supply Paradropping, Dropped Vehicle.
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGearEngineer", _side], [
	['AKS_74_U','ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],
	['30Rnd_545x39_AK','30Rnd_545x39_AK','30Rnd_545x39_AK','30Rnd_545x39_AK','PipeBomb'],
	['AKS_74_U']
]];
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGearOfficer", _side], [
	['AKS_74_kobra','ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGearSoldier", _side], [
	['Sa58V_RCO_EP1','ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],
	['30Rnd_762x39_SA58','30Rnd_762x39_SA58','30Rnd_762x39_SA58','30Rnd_762x39_SA58','HandGrenade_East','HandGrenade_East','HandGrenade_East','HandGrenade_East'],
	['Sa58V_RCO_EP1']
]];

// Lock MAN
missionNamespace setVariable [Format["WFBE_%1_DefaultGearLock", _side], [
	['bizon_silenced','ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],
	['64Rnd_9x19_SD_Bizon','64Rnd_9x19_SD_Bizon','64Rnd_9x19_SD_Bizon','64Rnd_9x19_SD_Bizon','HandGrenade_East','HandGrenade_East','HandGrenade_East','HandGrenade_East'],
	['bizon_silenced']
]];
