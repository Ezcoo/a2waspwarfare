...
WFBE_SK_V_Medics = ['FR_Corpsman','USMC_Soldier_Medic','RU_Soldier_Medic','US_Delta_Force_Medic_EP1','US_Soldier_Medic_EP1','TK_Soldier_Medic_EP1','CDF_Soldier_Medic','Ins_Soldier_Medic'];
