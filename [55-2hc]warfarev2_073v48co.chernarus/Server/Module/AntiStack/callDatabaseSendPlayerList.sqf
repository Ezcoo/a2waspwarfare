...

{
	...
	diag_log format ["_guid: %1, _parametersTemp == '': %2", _procedureName, (_parametersTemp == "")];
...
["INFORMATION", format ["CallDatabaseSendPlayerList.sqf: Called database successfully with procedure: [%1]. Response code is: %2.", _procedureName, _response]] Call WFBE_CO_FNC_LogContent;
