"wfbe_supply_west" addPublicVariableEventHandler {
	...
	["INFORMATION", format ["Server_ChangeSideSupply.sqf: Changing supply value of team %1. Current supply value that is being replaced: %2. New supply value for team: %3. Reason: %4. Current commander of team: %5.", _side, _amount, _change, _reason, name leader ((_side) call WFBE_CO_FNC_GetCommanderTeam)]] call WFBE_CO_FNC_LogContent;
