...
if (_unitType isKindOf "Man") then {
	...
	if(typeOf _vehicle in ['BRDM2_ATGM_CDF','BRDM2_ATGM_INS','BRDM2_ATGM_TK_EP1','BMP2_CDF','BMP2_Gue','BMP2_INS','BMP2_TK_EP1','BMP3','T90','M2A2_EP1','M2A3_EP1','HMMWV_TOW_DES_EP1','M1135_ATGMV_EP1']) then {_vehicle addeventhandler ['Fired',{_this spawn WFBE_CO_FNC_MonitorMissileGlitch;}];};
