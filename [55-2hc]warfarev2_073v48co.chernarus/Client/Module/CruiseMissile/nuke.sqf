...
_Cone = "#particlesource" createVehicleLocal _target;
...
_top = "#particlesource" createVehicleLocal _target;
...
_top2 = "#particlesource" createVehicleLocal _target;
...
_smoke = "#particlesource" createVehicleLocal _target;
...
_Wave = "#particlesource" createVehicleLocal _target;
...
_light = "#lightpoint" createVehicleLocal [((_target select 0)),(_target select 1),((_target select 2)+500)];
...
deleteVehicle _top2;
sleep 7;
_top3 = "#particlesource" createVehicleLocal _target;
...
_top4 = "#particlesource" createVehicleLocal _target;
...
_top5 = "#particlesource" createVehicleLocal _target;
...
_smoke2 = "#particlesource" createVehicleLocal _target;
