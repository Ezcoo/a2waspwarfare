...
switch (_type) do {
	...
	case "T72_RU":{
		_rearmor = {
   			...
   			switch (_ammo) do {
				...
				case "M_TOW_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
				case "M_TOW2_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
	...
	case "Ka52":{
	 	...
	 	_rearmor = {
   			...
   			switch (_ammo) do {
				case "Sh_125_SABOT" :{_dam=_this select 2; _p=50; _result=(_dam/100)*(100-_p);};
				case "Sh_120_SABOT" :{_dam=_this select 2; _p=50; _result=(_dam/100)*(100-_p);};
			...
			//	case "R_PG7V_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "R_PG7VL_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "R_M136_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "M_47_AT_EP1" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "R_MEEWS_HEAT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "M_AT13_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "M_TOW_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "M_TOW2_AT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "Sh_85_AP" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//	case "Sh_100_HEAT" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "B_20mm_AA" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "B_23mm_AA" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "B_25mm_HE" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "B_25mm_HEI" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "B_30mm_AA" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "B_30mm_HE" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
			//		case "Sh_40_HE" :{_dam=_this select 2; _p=0; _result=(_dam/100)*(100-_p);};
     			default {_result = _this select 2;};
    		};
   			_result
  		};
	...
	case "M2A2_EP1":{
		_rearmor = {
   			...
   			_result = 0;
   			switch (_ammo) do {
				case "R_SMAW_HEAA" :{_dam=_this select 2; _p=40; _result=(_dam/100)*(100-_p);};
				case "R_RPG18_AT" :{_dam=_this select 2; _p=30; _result=(_dam/100)*(100-_p);};
				case "R_PG9_AT" :{_dam=_this select 2; _p=30; _result=(_dam/100)*(100-_p);};
				case "R_PG7V_AT" :{_dam=_this select 2; _p=30; _result=(_dam/100)*(100-_p);};
				case "R_PG7VL_AT" :{_dam=_this select 2; _p=30; _result=(_dam/100)*(100-_p);};
				case "R_M136_AT" :{_dam=_this select 2; _p=20; _result=(_dam/100)*(100-_p);};
				case "M_47_AT_EP1" :{_dam=_this select 2; _p=40; _result=(_dam/100)*(100-_p);};
				case "R_MEEWS_HEAT" :{_dam=_this select 2; _p=43; _result=(_dam/100)*(100-_p);};
				case "M_AT13_AT" :{_dam=_this select 2; _p=23; _result=(_dam/100)*(100-_p);};
                    case "B_20mm_AA" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
					case "B_23mm_AA" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
					case "B_25mm_HE" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
					case "B_25mm_HEI" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
					case "B_30mm_AA" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
					case "B_30mm_HE" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
					case "Sh_40_HE" :{_dam=_this select 2; _p=25; _result=(_dam/100)*(100-_p);};
     			default {_result = _this select 2;};
    		};
   			_result
  		};
	...
	case "Mi24_V":{
		...
		_rearmor = {
			  ...
			  switch (_ammo) do {
				...
				case "R_PG7VL_AT" :{_dam=_this select 2; _p=170; _result=(_dam/100)*(100-_p);};
				...
				case "B_23mm_AA" :{_dam=_this select 2; _p=140; _result=(_dam/100)*(100-_p);};
				case "B_25mm_HE" :{_dam=_this select 2; _p=140; _result=(_dam/100)*(100-_p);};
				case "B_25mm_HEI" :{_dam=_this select 2; _p=140; _result=(_dam/100)*(100-_p);};
				...
				case "M_R73_AA" :{_dam=_this select 2; _p=400; _result=(_dam/100)*(100-_p);};
				default {_result = _this select 2;};
		   };
			  _result
		 };
