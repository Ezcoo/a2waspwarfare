	...
	if (WF_A2_CombinedOps) then {
		if (WF_Camo) then {
			if (random 100 > 50) then {
				_wteam = ['I44_Man_B_Army_AB_CO_StenMk5','I44_Man_B_Army_AB_BrenMk1','I44_Man_B_Army_AB_PIAT','I44_Man_B_Army_AB_Sniper_SMLENo4Mk1T'];
			} else {
				if ((missionNamespace getVariable "WFBE_C_MODULE_BIS_BAF") > 0) then {
					...
					_wteam = ['I44_Man_G_SS_NCO_MP43','I44_Man_G_SS_MG42','I44_Man_G_SS_RPzB54','I44_Man_G_SS_Sniper_G43Zf4'];
				};
			};
			_eteam = ['I44_Man_G_SS_NCO_MP43','I44_Man_G_SS_MG42','I44_Man_G_SS_RPzB54','I44_Man_G_SS_Sniper_G43Zf4'];
		} else {
			if (random 100 > 50) then {
