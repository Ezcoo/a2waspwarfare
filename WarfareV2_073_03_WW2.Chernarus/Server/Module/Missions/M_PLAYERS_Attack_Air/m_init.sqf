...
_chopper = "I44_Plane_B_HHmkIIa_HVAR_RAF";
...
//--- Man the chopper.
_pilot = ["I44_Man_R_F_WebleyMk6",_group,[0,0,0],WFBE_C_GUER_ID, false] Call WFBE_CO_FNC_CreateUnit;
...
//if (count _turrets > 0) then {[_turrets, [], _vehicle, "I44_Man_R_F_WebleyMk6", _group] call SpawnTurrets};
