...
#define WF_MAXPLAYERS 33
#define WF_MISSIONNAME "Warfare WW2 I44 V2.073.03 (WW2 content add by [W-R] Hannibal Based on BENNY Warfare)"
...
/* Load Screen (OA/CO) */
	...
	#define WF_LOADSCREEN __EVAL(["flags\1.paa","flags\p38.paa"] select round random 1)
