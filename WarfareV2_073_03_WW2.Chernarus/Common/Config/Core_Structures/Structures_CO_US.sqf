...
/* Root Definition */
_MHQ = if (WF_Camo) then {'I44_HT_A_M3_Army'} else {'I44_HT_A_M3_Army'};
...
/* Defenses */
	...
	_n = _n		+ ["I44_GunMG_A_M1919A4_TripodM2_Army"];
	_n = _n		+ ["I44_GunMG_A_M1919A4_TripodM2_c_Army"];
	_n = _n		+ ["I44_GunMG_B_Vickers_Army"];
	_n = _n		+ ["ZU23_CDF"];
	//_n = _n		+ ["I44_Gun_A_M2A1_Army"];
	_n = _n		+ ["I44_GunAT_A_M1_Army"];
	_n = _n		+ ["I44_GunAT_B_QF6pdrMk4_Army"];
	_n = _n		+ ["I44_GunAT_A_M3_Army"];
	_n = _n		+ ["I44_GunMortar_A_M2_Army"];
	_n = _n		+ ["I44_GunMortar_A_M1_Army"];
	_n = _n		+ ["I44_GunMortar_B_ML3in_Army"];
	_n = _n		+ ["SearchLight"];
	...
	_n = _n		+ ["Land_Campfire"];
	_n = _n		+ ["I44_AmmoBox_A_MP"];

/* Class used for AI, AI will attempt to build those */
missionNamespace setVariable [Format["WFBE_%1DEFENSES_MG", _side], ['I44_GunMG_A_M2HB_TripodM3_Army']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_GL", _side], ['I44_GunMG_A_M1919A4_TripodM2_Army']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_AAPOD", _side], ['I44_GunMG_A_M2HB_TripodAA_Army','ZU23_CDF']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_ATPOD", _side], ['I44_GunAT_A_M1_Army','I44_GunAT_B_QF6pdrMk4_Army']];
//missionNamespace setVariable [Format["WFBE_%1DEFENSES_CANNON", _side], ['I44_Gun_A_M2A1_Army']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_CANNON", _side], ['I44_GunAT_B_QF6pdrMk4_Army']];
