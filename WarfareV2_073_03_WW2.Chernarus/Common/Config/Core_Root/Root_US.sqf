...
if (isServer) then {
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS", _side], [
		[["US_Soldier_SL_EP1","US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_AR_EP1","US_Soldier_MG_EP1","US_Soldier_LAT_EP1","US_Soldier_EP1","US_Soldier_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"], 0, 2],
		[["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"], 50, 2],
		[["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_HAT_EP1","US_Soldier_HAT_EP1"], 70, 2],
		[["US_Delta_Force_TL_EP1","US_Delta_Force_Assault_EP1","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_EP1","US_Delta_Force_Medic_EP1"], 50, 1],
		[["US_Delta_Force_TL_EP1","US_Delta_Force_Assault_EP1","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_Medic_EP1","US_Delta_Force_M14_EP1","US_Delta_Force_Air_Controller_EP1"], 50, 2],
