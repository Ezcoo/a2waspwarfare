...
with missionNamespace do {
	...
	WFBE_C_PLAYERS_BOUNTY_CAPTURE = 400;
	WFBE_C_PLAYERS_BOUNTY_CAPTURE_ASSIST = 175;
	WFBE_C_PLAYERS_BOUNTY_CAPTURE_MISSION = 800;
	WFBE_C_PLAYERS_BOUNTY_CAPTURE_MISSION_ASSIST = 350;
	WFBE_C_PLAYERS_COMMANDER_BOUNTY_CAPTURE_COEF = 30;
	WFBE_C_PLAYERS_COMMANDER_SCORE_BUILD = 2;
	WFBE_C_PLAYERS_COMMANDER_SCORE_CAPTURE = 1;
	WFBE_C_PLAYERS_COMMANDER_SCORE_UPGRADE = 2;
	WFBE_C_PLAYERS_GEAR_SELL_COEF = 0.5; //--- Sell price of the gear: item price * x (800 * 0.5 = 400)
	...
	WFBE_C_TOWNS_UNITS_INACTIVE = 300; //--- Remove units in town if no enemies are to be found within that time.
	...
	if (isNil "WFBE_C_UNITS_CLEAN_TIMEOUT") then {WFBE_C_UNITS_CLEAN_TIMEOUT = 300}; //--- Lifespan of a dead body.
