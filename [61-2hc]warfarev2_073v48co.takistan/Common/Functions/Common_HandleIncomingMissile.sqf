...
if (_irLock == 0) then {if (_ammo in ["Bo_FAB_250","Bo_Mk82","40Rnd_S8T","80Rnd_S8T","38Rnd_FFAR","14Rnd_FFAR","6Rnd_CRV7_HEPD"]) then {_irLock = 1}}; //--- Dumb bomb workaround (rocket simulation).
