...
hint parseText "<t color='#28ff14'>If you're a new player:</t> <br/>Read the instructions that will soon show in chat. <br/><br/>Our Discord server: <br/><br/><t color='#28ff14'>discord.me/warfare</t>  <br/>(open the link with a web browser) <br/><br/>Ask in chat if you want to know how something works. Welcome and good luck, soldier! :)";
